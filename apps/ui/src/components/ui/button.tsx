...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        primary:
          'bg-gradient-to-r from-brand-600 to-cyan-600 text-white shadow-sm hover:from-brand-700 hover:to-cyan-700 hover:shadow-md focus:ring-brand-500',
        secondary:
        ...
        default:
          'bg-gradient-to-r from-brand-600 to-cyan-600 text-white shadow-sm hover:from-brand-700 hover:to-cyan-700 hover:shadow-md',
        destructive:
          'bg-red-500 text-white shadow-sm hover:bg-red-600 dark:bg-red-900 dark:hover:bg-red-800',
      },
      size: {
